...
function (_React$Component) {
  ...
  function Header() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Header.__proto__ || Object.getPrototypeOf(Header)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      writable: true,
      value: function value() {
        var mobile = window.outerWidth < 855;
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var moblieMenu = this.state.moblie ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
...
//# sourceMappingURL=5.073c8dd4ef3b6e5fc6ae.hot-update.js.map