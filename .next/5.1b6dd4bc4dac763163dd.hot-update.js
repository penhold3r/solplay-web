...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      ...
      var mainClass = this.state.productModal || this.state.certificateModal ? 'no-scroll' : 'scroll';
      this.setState({
        sections: sections,
        mainClass: mainClass
      });
      this.waitForImages();
      console.log('mount -> ', this.state.productModal || this.state.certificateModal);
    }
  }, {
...
//# sourceMappingURL=5.1b6dd4bc4dac763163dd.hot-update.js.map