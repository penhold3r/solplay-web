...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      var icon = __WEBPACK_IMPORTED_MODULE_3__src_data_data__["a" /* default */].main[1].icons[0].icon;
      console.log(icon);
      ...
      }, "Solplay"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", {
        src: icon,
        alt: "",
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=5.1f43d5745784e47a8a8a.hot-update.js.map