...
function (_React$Component) {
  ...
  function Index(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "handleScrollTo", {
      ...
      enumerable: true,
      writable: true,
      value: function value(section) {//const ref = ReactDOM.findDOMNode(this.refs[section]);
        // console.log('r: ', this[section].current);
...
//# sourceMappingURL=5.3a461ee4af78efa918b4.hot-update.js.map